...
int main() {
    ...
    // Load the file name from data_source.txt
...
void showMenu() {
    std::cout << "Menu:\n";
    std::cout << "1. Average wind speed and standard deviation for a month and year\n";
    std::cout << "2. Average temperature and standard deviation for each month of a year\n";
    std::cout << "3. Total solar radiation for each month of a year\n";
    std::cout << "4. Export wind speed, temperature, and solar radiation to CSV file\n";
    std::cout << "5. Exit\n";
